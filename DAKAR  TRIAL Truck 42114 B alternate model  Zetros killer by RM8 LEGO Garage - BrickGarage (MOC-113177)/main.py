...
driving_2 = Motor(Port.C, Direction.COUNTERCLOCKWISE)
...
while True:
    ...
    if Button.RIGHT_PLUS in pressed:
        steering.run_target(1400, steering_angle_left, Stop.HOLD, False)
    elif Button.RIGHT_MINUS in pressed:
        steering.run_target(1400, steering_angle_right, Stop.HOLD, False)
    else:
